        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-start">
          ...
          <div>
            ...
            <FadeIn delay={0.1} distance={20}>
              <h2 className="font-sans font-extrabold text-[2.75rem] sm:text-[3.25rem] lg:text-[4rem] leading-[1.05] tracking-tight text-[#414042]">
                Specialist support, <span className="text-[#eb0045]">with
                <br />
            ...
            <FadeIn delay={0.2} distance={20}>
              <div className="text-[1.125rem] text-[#666666] leading-[1.6] relative z-10">
                ...
                <div className="mt-6">
                  <a
                    href="#"
                    className="group relative inline-flex items-center gap-2 font-sans font-bold text-[#eb0045] transition-colors pb-1"
                  >
                    ...
                    {/* Animated Underline */}
                    <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#eb0045] transition-all duration-300 ease-out group-hover:w-full"></span>
                  </a>
                </div>
              </div>
            </FadeIn>
