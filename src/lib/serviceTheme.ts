...
export const serviceThemes: Record<string, ServiceTheme> = {
  "transfer-pricing": {
    ...
    accentLight: "rgba(235, 0, 69, 0.12)",
    accentBorder: "border-[#eb0045]/30",
    accentBadgeBg: "bg-[#eb0045]/10 text-[#eb0045]",
    accentBadgeText: "text-[#eb0045]",
    heroGradient: HERO_GRADIENT,
    cardBorderHover: "hover:border-[#eb0045]",
