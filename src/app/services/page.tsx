...
export default function ServicesPage() {
  ...
  return (
    <div className="service-page bg-white text-[#17232c]">
      ...
      <section className="border-b border-[#e8e7e4] bg-[#111b23] py-10 sm:py-14">
                ...
                <Link key={service.slug} href={`/services/${service.slug}`} className="group flex min-w-0 flex-col overflow-hidden rounded-tr-[2.5rem] border border-[#e8e7e4] bg-[#faf9f6] transition-[border-color,box-shadow] duration-300 hover:border-[#e00019]/40 hover:shadow-[0_16px_40px_-20px_rgba(17,27,35,0.3)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#c80016]">
                  ...
                  <div className="flex flex-1 flex-col p-6 lg:p-7">
                    ...
                    <div className="mt-auto flex items-center justify-between gap-4 border-t border-[#deddd8] pt-5">
                      <span className="text-xs font-semibold text-[#111b23] transition-colors group-hover:text-[#e00019]">Explore service</span>
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#d8d6d0] text-[#e00019] transition-colors group-hover:border-[#e00019] group-hover:bg-[#e00019] group-hover:text-white"><ArrowUpRight className="h-5 w-5" aria-hidden="true" /></span>
                    </div>
                  </div>
                </Link>
              ))}
